...
title: Scan
hide_title: true
slug: /actions/sonarqube/scan
---

import ThemedImage from '@theme/ThemedImage'
import sonarDarkIcon from "../../assets/sonar-dark.png"
import sonarLightIcon from "../../assets/sonar-light.png"

<ThemedImage 
    style={{height:'75px', margin: '20px 0 20px 0', marginLeft: '-15px'}} 
    sources={{    
        light: sonarDarkIcon,
        dark: sonarLightIcon,
    }}
