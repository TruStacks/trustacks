...
<!--- // TODO: uncomment for trustacks cloud
...
Clone the forked repo and run the following command from the root of the source:

```
tsctl plan --name trustacks-react-sample
```
